...
const ChannelKindNoise    = 3 as const;
const ChannelKindPCM      = 4 as const;
const ChannelKindSaw      = 5 as const;
const ChannelKindWave     = 6 as const;
  ...
  note(
    ...
    this.events.push({
      ...
      value: [
        ...
        (attack ? 0x8000 : 0) | (((release >> 8) & 0x7) << 11) | duration
      ]
    });
  }
...
function parseFile(fileData: string): Chunk[] {
...
const rootChildren = parseFile(await fs.readFile(inputFile, 'utf8'));
